...
import { FaPlus, FaHome , FaCheckCircle,FaServicestack, FaShoppingCart ,FaEye} from 'react-icons/fa';
  ...
  return (
    ...
    <div className="sidebar">
      <ProSidebar>
        ...
        <SidebarContent>
          ...
          <MenuItem style={{fontSize:'18px'}} icon={<FaEye size={20}/>} ><Link to="/dashboard/status">Status</Link></MenuItem>
    ...
    <div className='mobileSidebar'>
      ...
      <div>
        ...
        <p className='text-center p-2'><Link to="/dashboard/status"><i class="fa-sharp fa-solid fa-eye text-white"></i></Link></p>
